import { faBathtub, faBed,faDog,faCar } from "@fortawesome/free-solid-svg-icons";
...
export const PropertyCard =({title,destination,image,bedrooms,bathrooms,price,hasParking,petFriendly})=>{
    return(
        <Link href={destination} className="border-2 border-slate-300 p-5 block bg-slate-100 text-black hover:bg-slate-200">
